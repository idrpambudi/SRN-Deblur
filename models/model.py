        ...
        with tf.variable_scope(scope, reuse=reuse):
            with slim.arg_scope([slim.conv2d, slim.conv2d_transpose, slim.separable_conv2d],
                ...
                for i in range(self.n_levels):
                    ...
                    conv1_1_dw = slim.separable_conv2d(inp_all, 32, [5, 5], scope='enc1_1_dw')
                    ...
                    conv2_1_dw = slim.separable_conv2d(conv1_4, 64, [5, 5], stride=2, scope='enc2_1_dw')
                    ...
                    conv3_1_dw = slim.separable_conv2d(conv2_4, 128, [5, 5], stride=2, scope='enc3_1_dw')
